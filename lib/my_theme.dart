...
class MyTheme{
  ...
  static Color accent_color = Colors.blueGrey.shade700;
  static Color soft_accent_color = Colors.blue.shade200;
  static Color splash_screen_color = Colors.blue.shade300; // if not sure , use the same color as accent color
  ...
  static Color golden = Color.fromRGBO(248, 130, 90, 1);
